...
class PaymentPage extends StatelessWidget {
  PaymentPage({Key? key, required this.totalPrice, required this.customerId,required this.videoIds})
      : super(key: key);
...
print("videoIds.length========${videoIds.length.toString()}");
                        ...
                        child: Text(
                            '${totalPrice.toString()} so\'m || Tasdiqlash')),
                  )
                ],
              ),
            ),
