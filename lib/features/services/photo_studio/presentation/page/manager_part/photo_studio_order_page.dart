...
class PhotoStudioOrderPage extends StatefulWidget {
  ...
  PhotoStudioOrderPage({Key? key, required this.customerId})
      : super(key: key);

  @override
  State<PhotoStudioOrderPage> createState() =>
      _PhotoStudioOrderPageState();
}

class _PhotoStudioOrderPageState
    extends State<PhotoStudioOrderPage> {
  final uuid = Uuid();
